...
const SphereAnimation = () => {
  ...
  return (
    <div className="animation-wrapper relative">
...
// Eklediğim CSS stilini aşağıdaki gibi ekleyebilirsiniz.
import "./SphereAnimation.css"; // Bu dosyayı oluşturun ve gerekli stil bilgilerini içine ekleyin.
